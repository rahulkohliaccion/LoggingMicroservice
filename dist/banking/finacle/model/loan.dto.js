...
class LoanInstallmentDTO {
    static _OPENAPI_METADATA_FACTORY() {
        return { cICrvLoanGenDetailsOutStruct: { required: true, type: () => cICrvLoanGenDetailsOutStructDTO } };
    }
}
